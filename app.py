...
cl_2 = datetime.time(hour=18, minute=7, second=00,tzinfo=pytz.timezone('Asia/Kolkata'))
...
def func(context: telegram.ext.CallbackContext):
    context.bot.send_message(chat_id='967948229', text=links[11])
...
def func(context: telegram.ext.CallbackContext):
    context.bot.send_message(chat_id='967948229', text=links[1])
...
def func(context: telegram.ext.CallbackContext):
    context.bot.send_message(chat_id='967948229', text=links[2])
...
def func(context: telegram.ext.CallbackContext):
    context.bot.send_message(chat_id='967948229', text=links[3])
...
def func(context: telegram.ext.CallbackContext):
    context.bot.send_message(chat_id='967948229', text=links[4])
...
def func(context: telegram.ext.CallbackContext):
    context.bot.send_message(chat_id='967948229', text=links[5])
...
def func(context: telegram.ext.CallbackContext):
    context.bot.send_message(chat_id='967948229', text=links[12])
...
def func(context: telegram.ext.CallbackContext):
    context.bot.send_message(chat_id='967948229', text=links[7])
...
def func(context: telegram.ext.CallbackContext):
    context.bot.send_message(chat_id='967948229', text=links[8])

job_daily = job.run_daily(func, days=(3,3), time=cl_2)

def func(context: telegram.ext.CallbackContext):
    context.bot.send_message(chat_id='967948229', text=links[9])

job_daily = job.run_daily(func, days=(4,4), time=cl_1)

def func(context: telegram.ext.CallbackContext):
    context.bot.send_message(chat_id='967948229', text=links[10])
